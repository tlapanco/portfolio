...
import { GITHUB_PROFILE, PDF_URL } from "../constants/hero";
      ...
      <div className="grid md:grid-cols-2 place-items-center gap-8">
        ...
        >
          ...
          >
            ¡Hola!, soy <br />
            <TypeAnimation
              sequence={["Fabian At", 1000, "Programador", 1000, "Tutor", 1000]}
              speed={50}
              repeat={Infinity}
          ...
          >
            Apasionado por la creación de aplicaciones web y el aprendizaje de
            nuevas tecnologías.
          </motion.p>
          <motion.div
            initial={{ opacity: 0 }}
